...
mod tests {
    ...
    #[tokio::test]
    async fn s04_c32_breaking_hmac_sha1_with_slightly_less_artificial_timing_leak() {
        ...
        for i in 0..20 {
            ...
            for byte in 0..=255 {
                ...
                for _ in 0..n_tries {
                    delay_sum += measure_delay(&client, &url).await
                }
                let mean_delay = delay_sum / n_tries as u32;

                if mean_delay > best_delay {
